...
describe User do
  ...
  describe "when email format is valid" do
    it "should be valid" do
      addresses = %w[user@foo.com A_USER@f.b.org frst.lst@foo.jp a+b@baz.de]
  ...
  describe "microsamples associations" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.microsamples.create!(content: "Lorem ipsum") }
      end
      ...
      its(:feed) do
        followed_user.microsamples.each do |microsample|
          should include(microsample)
        end
      end
    end
  end
